    ...
    public partial class EstruturaInicial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ListadeCuidadoresId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    ListadeIdososId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UtilizadorUtilizador", x => new { x.ListadeCuidadoresId, x.ListadeIdososId });
                    table.ForeignKey(
                        name: "FK_UtilizadorUtilizador_AspNetUsers_ListadeCuidadoresId",
                        column: x => x.ListadeCuidadoresId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UtilizadorUtilizador_AspNetUsers_ListadeIdososId",
                        column: x => x.ListadeIdososId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                ...
                table: "UtilizadorUtilizador",
                column: "ListadeIdososId");
        }
